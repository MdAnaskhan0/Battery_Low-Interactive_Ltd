...
function forEach(children, func) {
  ...
  React30.Children.forEach(children, (child) => {
    if (React30.isValidElement(child)) func(child, index++);
  });
}
...
var FormLabel = React46.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime48.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var Modal = React62.forwardRef(({
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime75.jsxs)(import_jsx_runtime74.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react28.cloneElement)(children, triggerProps), (0, import_jsx_runtime73.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
